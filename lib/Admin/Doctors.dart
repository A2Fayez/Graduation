...
class _MyHomePageState extends State<MyHomePage> {
  List<ListItem> items = [
    ListItem(text: 'gamalelfarouk@gmail.com'),
    ListItem(text: 'hatemmohamed@gmail.com'),
    ListItem(text: 'arabykeshk@gmail.com'),
    ListItem(text: 'nouraelsemary@gmail.com'),
    ListItem(text: 'emanmeshly@gmail.com'),
    ListItem(text: 'aminaelmahlawy@gmail.com'),
    ListItem(text: 'minamaher@gmail.com')
  ];
